...
![NekoBox右键手动输入](/img/guide/static-proxy/nekoray-step1.png)
...
![NekoBox编辑窗口](/img/guide/static-proxy/nekoray-step2.png)

### 第三步：确认节点已添加到列表

保存成功后，回到主界面，你可以在**服务器列表**中看到刚添加的节点信息：类型为 `Socks`，地址和名称均显示正确。

![NekoBox服务器列表](/img/guide/static-proxy/nekoray-step3.png)
...
![NekoBox启动节点](/img/guide/static-proxy/nekoray-step4.png)
