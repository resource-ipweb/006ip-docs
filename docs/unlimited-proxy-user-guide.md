...
description: 006ip unlimited proxy user guide — purchase unlimited proxy plans, view purchased services and credentials, understand proxy string fields, and verify connectivity.
---

# 006IP Unlimited Proxy User Guide

## 1. How to purchase an unlimited proxy plan

Log in to your 006IP dashboard. In the left navigation, go to **Unlimited Proxy > Purchase Plan**. On this page, select the plan options that match your usage needs and complete the payment.

### Step 1: Select your plan options

On the **Purchase Plan** page, configure the following options:

- **Available country/region:** Select the country or region where the access server is located, such as Singapore (`SG`) or the United States (`US`).
...
![Unlimited proxy purchase plan](https://cdn.006ip.com/docs/img/unlimited-proxy/en/purchase-plan.png)

Unlimited Proxy plans are primarily configured by **bandwidth and service period**. Traffic usage is unlimited during the active service period. Available bandwidth is determined by the plan you purchase.
...
After payment is completed successfully, the system will begin provisioning the Unlimited Proxy service for your order.

Provisioning typically takes approximately **3 to 5 minutes** after the order is confirmed. Once the service is ready, you can view and use the purchased proxy resources from the Unlimited Proxy section of the dashboard.

---

## 2. View purchased unlimited proxy IPs

Once your Unlimited Proxy plan has been activated, you can view the corresponding service instance, proxy credentials, and connection information in the 006IP dashboard.

### Step 1: Open Get Proxy

In the left-hand navigation, click **Get Proxy**. The page will display information for the currently selected Unlimited Proxy service, including:
...
The **My Services** panel lists all Unlimited Proxy service instances under your account. Each instance displays:
...
- **Proxy Username:** The base username generated for the current Unlimited Proxy service.
...
- **Account:** `63j7gpxb00` — your Unlimited Proxy service account. This value stays the same.
